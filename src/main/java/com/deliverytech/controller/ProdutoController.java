...
public class ProdutoController {
    ...
    @Operation(summary = "Atualiza um produto", description = "Atualiza os dados de um produto existente  a partir do ID.")
    @PutMapping("/{id}")
...
@Operation(summary = "Altera a disponibilidade de um produto", description = "Altera o status de um produto (disponível/indisponível) a partir do ID.")
